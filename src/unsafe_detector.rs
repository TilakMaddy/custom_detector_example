...
mod unsafe_erc20_functions_tests {
    use aderyn_core::detect::detector::{detector_test_helpers::load_contract, Detector};
    ...
    fn test_unsafe_erc20_functions() {
        let context_loader = load_contract(
            "/Users/tilakmadichetti/Documents/OpenSource/aderyn/tests/contract-playground/out/DeprecatedOZFunctions.sol/DeprecatedOZFunctions.json",
        );
        ...
        assert_eq!(
            detector.severity(),
            aderyn_core::detect::detector::IssueSeverity::Low
        );
